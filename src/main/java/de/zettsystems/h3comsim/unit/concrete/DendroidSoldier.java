...
public class DendroidSoldier extends AbstractUnit {

    private final static String NAME = "Dendroid Soldier";
    private final static int ATTACK = 9;
    private final static int DEFENSE = 12;
    private final static int HEALTH = 65;
