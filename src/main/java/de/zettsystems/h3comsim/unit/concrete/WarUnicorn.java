...
public class WarUnicorn extends AbstractUnit {

    private final static String NAME = "War Unicorn";
    ...
    private final static int MIN_DAMAGE = 18;
    private final static int MAX_DAMAGE = 22;
    private final static Movement MOVEMENT = Movement.GROUND;
    private final static int SHOTS = 0;
    private final static int COST = 950;
