...
public class GoldDragon extends AbstractUnit {

    private final static String NAME = "Gold Dragon";
    private final static int ATTACK = 27;
    private final static int DEFENSE = 27;
