...
import static de.zettsystems.h3comsim.unit.common.UnitSpeciality.TWO_BLOWS;

public class Crusader extends AbstractUnit {

    private final static String NAME = "Crusader";
    private final static int ATTACK = 12;
    private final static int DEFENSE = 12;
    private final static int HEALTH = 35;
