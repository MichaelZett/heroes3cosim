...
import static de.zettsystems.h3comsim.unit.common.UnitSpeciality.COUNERSTRIKE_UNLIMITED;

public class RoyalGriffin extends AbstractUnit {
    ...
    private final static int COST = 240;
    private final static AttackType ATTACK_TYPE = AttackType.HAND_TO_HAND;

    public RoyalGriffin() {
        super(HEALTH, Set.of(COUNERSTRIKE_UNLIMITED));
    }
