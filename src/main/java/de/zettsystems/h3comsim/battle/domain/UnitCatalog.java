...
import static de.zettsystems.h3comsim.battle.domain.UnitSpeciality.DEATH_CLOUD;
...
public final class UnitCatalog {
    ...
    public static final Unit BLACK_DRAGON = upgrade("Black Dragon", new Stats(25, 25, 300, 15), melee(40, 50), FLYING, DUNGEON, 7, 4000, IMMUNE_TO_SPELLS, TITAN_HATE, FIRE_BREATH);
    ...
    public static final Unit CERBERUS = upgrade("Cerberus", new Stats(10, 8, 25, 8), melee(2, 5), GROUND, INFERNO, 3, 250, NO_RETALIATION, THREE_HEADED_ATTACK);
    ...
    public static final Unit GOLD_DRAGON = upgrade("Gold Dragon", new Stats(27, 27, 250, 16), melee(40, 50), FLYING, RAMPART, 7, 4000, IMMUNE_TO_SPELLS_BELOW_4, FIRE_BREATH);
    ...
    public static final Unit GREEN_DRAGON = basic("Green Dragon", new Stats(18, 18, 180, 10), melee(40, 50), FLYING, RAMPART, 7, 2400, FIRE_BREATH);
    ...
    public static final Unit LICH = basic("Lich", new Stats(13, 10, 30, 6), ranged(11, 13, 12), GROUND, NECROPOLIS, 5, 550, DEATH_CLOUD);
